      ...
      <div className="flex flex-col md:flex-row gap-4">
        ...
        <div className="w-full md:w-3/4">
          ...
          <div className="mb-2">
            ...
            <span data-testid="doctor-specialty">{doctor.specialties?.join(", ") || "Not specified"}</span>
          </div>
          ...
          <div className="mb-2">
            ...
            <span data-testid="doctor-fee">₹{doctor.fee}</span>
          </div>

          <div className="mb-2">
            <span className="text-sm font-semibold text-gray-600">Consultation Type:</span>{" "}
            <span className="inline-block px-2 py-1 bg-gray-100 text-xs rounded-full">{doctor.consultationType}</span>
          </div>
